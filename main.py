...
print("Appuyez sur 'A' pour activer le relais 13 pendant 0,5 seconde (si ce n'était pas le dernier activé).")
print("Appuyez sur 'Z' pour activer le relais 12 pendant 0,5 seconde (si ce n'était pas le dernier activé).")
print("Appuyez sur 'O' pour activer le relais 8 pendant 0,5 seconde (si ce n'était pas le dernier activé).")
print("Appuyez sur 'P' pour activer le relais 7 pendant 0,5 seconde (si ce n'était pas le dernier activé).")
...
# Code that activate during 0.5 second relay if it was not the last relay activated.
