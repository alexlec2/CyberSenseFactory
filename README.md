...
## Build exe
```bash
pyinstaller --onefile --add-data "images/position_1.png;images/" --add-data "images/position_2.png;images/" -w ui_control.exe --name Scada --icon images/icon.png

pyinstaller --onefile --add-data "images/position_1.png;images/" --add-data "images/position_2.png;images/" -w ui_control_withoutArduino.exe --name ScadaWithoutArduino --icon images/icon.png
```
